...
TEST_CASE("Load db file", "[PackageList]") {
  ...
  Package want;
  PackageVersion version("1.0.0", "1.5.2.1", "9.0", "linux", X86_64,
...
TEST_CASE("Find Package Version") {
    ...
    SECTION("Successfully find package") {
        optional<PackageVersion> version =
            pkglist.find_latest_package_version("Butt", "linux", arch, ChuckVersion("1.5.2.0"), ApiVersion("8.8"));
    ...
    SECTION("Can't find package") {
        optional<PackageVersion> version =
            pkglist.find_latest_package_version("Fork", "linux", arch, ChuckVersion("1.5.2.0"), ApiVersion("8.8"));
