...
public:
  ...
  virtual bool fetch(string data, fs::path dir, Package package, fs::path temp_dir, FileType file_type, string checksum) = 0;
...
public:
  ...
  bool fetch(string data, fs::path dir, Package package, fs::path temp_dir, FileType file_type, string checksum);
